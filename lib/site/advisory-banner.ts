export const ADVISORY_BANNER_EYEBROW = "공식 자문단 인증";

export const ADVISORY_BANNER_HEADLINE =
  "가짜 영수증 리뷰, 광고로 도배된 블로그 글에 아직도 속고 계십니까?";

export const ADVISORY_BANNER_DESCRIPTION =
...
export const ADVISORY_PAGE_PATH = "/services/academy/advisory";
