...
export const REGION_NEARBY_DISTRICTS: Record<string, string[]> = {
  ...
  연수: ["송도동", "연수동", "청학동", "옥련동", "동춘동"],
  남동구: ["구월동", "논현동", "간석동", "만수동", "장수동"],
  남동: ["구월동", "논현동", "간석동", "만수동", "장수동"],
  계양구: ["계산동", "작전동", "효성동", "병방동", "동양동"],
  계양: ["계산동", "작전동", "효성동", "병방동", "동양동"],
  서구: ["검단동", "연희동", "청라동", "가좌동", "마전동"],
  미추홀구: ["주안동", "도화동", "관교동", "문학동", "숭의동"],
  미추홀: ["주안동", "도화동", "관교동", "문학동", "숭의동"],
  부평구: ["부평동", "삼산동", "청천동", "갈산동", "십정동"],
  // 서울 강남권
  ...
  은평: ["응암동", "불광동", "녹번동", "갈현동", "대조동"],
  은평구: ["응암동", "불광동", "녹번동", "갈현동", "대조동"],
  도봉: ["쌍문동", "창동", "방학동", "도봉동", "미아동"],
  도봉구: ["쌍문동", "창동", "방학동", "도봉동", "미아동"],
  관악: ["봉천동", "신림동", "남현동", "서원동", "인헌동"],
